...
main.o: main.c gol.h  
	$(CC) -c main.c -Wall -pedantic -lncursesw

init_game.o: init_game.c gol.h
	$(CC) -c init_game.c -Wall -pedantic -lncursesw

init_table.o: init_table.c gol.h
	$(CC) -c init_table.c -Wall -pedantic -lncursesw

count_neighbours.o: count_neighbours.c gol.h 
	$(CC) -c count_neighbours.c -Wall -pedantic -lncursesw

calculate_game.o: calculate_game.c gol.h
	$(CC) -c calculate_game.c -Wall -pedantic -lncursesw
